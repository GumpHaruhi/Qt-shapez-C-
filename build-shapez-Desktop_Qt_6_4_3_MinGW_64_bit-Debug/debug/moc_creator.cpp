...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Creator_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Creator_t qt_meta_stringdata_Creator = {
    {
        QT_MOC_LITERAL(0, 7)   // "Creator"
    },
    "Creator"
};
...
Q_CONSTINIT static const uint qt_meta_data_Creator[] = {
...
Q_CONSTINIT const QMetaObject Creator::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseTool::staticMetaObject>(),
    qt_meta_stringdata_Creator.offsetsAndSizes,
    qt_meta_data_Creator,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Creator_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Creator, std::true_type>
    >,
    nullptr
} };
