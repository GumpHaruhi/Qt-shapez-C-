...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Mixer_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Mixer_t qt_meta_stringdata_Mixer = {
    {
        QT_MOC_LITERAL(0, 5)   // "Mixer"
    },
    "Mixer"
};
...
Q_CONSTINIT static const uint qt_meta_data_Mixer[] = {
...
Q_CONSTINIT const QMetaObject Mixer::staticMetaObject = { {
    ...
    qt_meta_stringdata_Mixer.offsetsAndSizes,
    qt_meta_data_Mixer,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Mixer_t,
        // Q_OBJECT / Q_GADGET
...
void *Mixer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Mixer.stringdata0))
