...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Kitchen_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Kitchen_t qt_meta_stringdata_Kitchen = {
    {
        QT_MOC_LITERAL(0, 7)   // "Kitchen"
    },
    "Kitchen"
};
...
Q_CONSTINIT static const uint qt_meta_data_Kitchen[] = {
...
Q_CONSTINIT const QMetaObject Kitchen::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseTool::staticMetaObject>(),
    qt_meta_stringdata_Kitchen.offsetsAndSizes,
    qt_meta_data_Kitchen,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Kitchen_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Kitchen, std::true_type>
    >,
    nullptr
} };
